...
public class FullStackDeveloperTodoListApplication {

	//Uygulama başlatıldığında çağrılır ve varsayılan zaman dilimini "IST" olarak ayarlar.
	@PostConstruct
	public void init() {
	...
	public static void main(String[] args) {
		...
		// Main
		SpringApplication.run(FullStackDeveloperTodoListApplication.class, args);
	}//end PSVM

}//end FullStackDeveloperTodoListApplication
