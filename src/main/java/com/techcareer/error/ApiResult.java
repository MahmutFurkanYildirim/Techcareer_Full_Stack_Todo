...
// Eğer sistemde null değer varsa backendde gönderme
...
public class ApiResult {
    ...
    public ApiResult() {
    }//end non parameter constructor ApiResult
    ...
    public ApiResult(String path, String message,  int status) {
        ...
        this.status = status;
    }//end parameter constructor ApiResult
    ...
    public ApiResult(String path, String message, String error, int status) {
        ...
        this.error = error;
        this.status = status;
    }//end second parameter constructor ApiResult
}//end ApiResult
